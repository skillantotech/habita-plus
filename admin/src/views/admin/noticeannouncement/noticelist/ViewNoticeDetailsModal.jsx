...
const ViewNoticeDetailsModal = ({ isOpen, onClose, formData }) => {
  ...
  const handleInput = (e) => {
    ...
    setNoticeViewForm({ ...noticeViewForm, [name]: value });
  };

  const handleRadioChange = (value) => {
    setNoticeViewForm({ ...noticeViewForm, userGroupId: value });
  };
        ...
        <div className="flex flex-col w-full gap-5 py-6">
          <div>
            <Input
              ...
              value={noticeViewForm?.noticeHeading || ""}
              type="text"
              name="noticeHeading"
          ...
          <div>
            ...
            <textarea
              id="message"
              rows="4"
              value={noticeViewForm?.noticeDescription || ""}
          ...
          <div>
            <Input
              ...
              type="date"
              value={formatDate(noticeViewForm?.noticeExpireDate)} // Format date to "YYYY-MM-DD"
          ...
          <div className="grid grid-cols-4 gap-5 items-center my-5">
            <div className="flex flex-row items-center gap-3">
              ...
              <input
                type="radio"
                name="userGroupId"
                checked={noticeViewForm.userGroupId === 1} // Check if the value is 1
            ...
            <div className="flex flex-row items-center gap-3">
              ...
              <input
                type="radio"
                name="userGroupId"
                checked={noticeViewForm.userGroupId === 2} // Check if the value is 2
            ...
            <div className="flex flex-row items-center gap-3">
              ...
              <input
                type="radio"
                name="userGroupId"
                checked={noticeViewForm.userGroupId === 3} // Check if the value is 3
            ...
            <div className="flex flex-row items-center gap-3">
              ...
              <input
                type="radio"
                name="userGroupId"
                checked={noticeViewForm.userGroupId === 4} // Check if the value is 4
