...
const ViewUserDetailsModal = ({ isOpen, onClose, formData }) => {
      ...
      <div className="p-10 my-5 border rounded-lg bg-gray-100">
        {/* <div className="grid grid-cols-3 gap-5 items-center py-6">
          <Input
            ...
            value={userViewForm?.visit_expect_date_of_entry_date?.slice(0, 10) || ""} 
            readOnly
          />
          <Input
          ...
          <Input
            ...
            type="text"
            name="visit_mobileno"
            value={userViewForm?.visit_mobileno || ""}
            readOnly
          />
          <Input
            label="Relationship"
            type="text"
            name="relationship"
            value={userViewForm?.relationship || ""}
            readOnly
          />
          <Input
            ...
            type="text"
            name="visit_porpous"
            value={userViewForm?.visit_porpous || ""}
            readOnly
          />
          <div>
            <label
            ...
            <textarea
              id="visit_location"
              name="visit_location"
              value={userViewForm?.visit_location || ""}
              readOnly
