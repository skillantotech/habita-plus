...
const DefinePurposeEdit = ({ isOpen, onClose, formData, onEditHandler }) => {
  ...
  useEffect(() => {
    setEditDefinePurpose(formData); // Set the form data when component mounts or formData changes
  }, [formData]);
        ...
        <div className="grid grid-cols-3 gap-5 items-center mt-3">
          <div class="flex items-center mb-4">
            <input
              ...
              value="created"
              name="status"
              checked={editDefinePurpose?.status === "created"}
          ...
          <div class="flex items-center mb-4">
            <input
              ...
              value="expired"
              name="status"
              checked={editDefinePurpose?.status === "expired"}
              onChange={handleStatusChange}
              class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500   focus:ring-2 "
            />
            <label
