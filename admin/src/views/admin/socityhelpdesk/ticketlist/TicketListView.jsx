...
const TicketListView = ({ isOpen, onClose, formData }) => {
  const [viewTicketList, setViewTicketList] = useState(formData);
  console.log("viewTicketList", viewTicketList);

  useEffect(() => {
    setViewTicketList(formData); // Set the form data when component mounts or formData changes
  }, [formData]);
  return (
    <Dialog
      isOpen={isOpen}
    ...
    >
      <div className="p-10 my-5 border rounded-lg bg-gray-100">
        ...
        <Input
          ...
          type="text"
          name="ticketTitle"
          value={viewTicketList?.ticketTitle || ""}
          //   onChange={handleInputChange}
        ...
        <TextArea
          ...
          value={viewTicketList?.ticketDetails.ticket_details_description || ""} //   onChange={handleInputChange} // Updates the state on every change
