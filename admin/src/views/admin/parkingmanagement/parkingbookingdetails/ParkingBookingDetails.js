...
const ParkingBookingDetails = () => {
  const paths = ["Parking Management", "Parking Booking Details"];
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 ">
            <tr>
              ...
              <th scope="col" className="px-6 py-3">
                Parking Slot Booked by
              </th>
              <th scope="col" className="px-6 py-3">
                Parking Slot Booking Member Name
              </th>
              <th scope="col" className="px-6 py-3">
                Parking Slot Booking Member Contact Number
              </th>
              <th scope="col" className="px-6 py-3">
                Action
              </th>
          ...
          <tbody>
            <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
              <td className="px-6 py-4">
                Parking Name/Number as Provided by Society
              </td>
