        ...
        <div className="flex grid-cols-6 gap-5 items-center my-5">
          <div className="w-40 flex flex-row items-center gap-3">
            ...
            <input
              type="radio"
              name="drone"
              checked={formData.role === 13}
              onChange={() => handleRoleChange(13)}
            />
          </div>
          <div className="w-40 flex flex-row items-center gap-3">
            ...
            <input
              type="radio"
              name="drone"
              checked={formData.role === 12}
              onChange={() => handleRoleChange(12)}
            />
          </div>
          <div className="w-40 flex flex-row items-center gap-3">
            ...
            <input
              type="radio"
              name="drone"
              checked={formData.role === 11}
              onChange={() => handleRoleChange(11)}
            />
          </div>
        </div>
      </div>
