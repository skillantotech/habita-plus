...
const Info = () => {
  return (
    <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3 lg:gap-4">
      <div className="bg-blue-100 hover:bg-blue-200 transition-all duration-300 p-5 rounded-xl cursor-pointer hover:scale-[102%]">
        <div className="flex items-center gap-4">
          <span className="p-2 md:p-3 lg:p-4 rounded-full border border-turquoise">
